...
/**
 * @author Matt Wright Class: CIS425 Exercise: One (Average.java) Goal: Fill in
 *         the blanks following desired program functions
 */
...
public class Average {
  ...
  public static void main(String args[]) {
    ...
    for (int i = 1; i <= 10; i++) {
      ...
      if (!sc.hasNextInt()) {
        // System.err will print the message in RED, skip the line and decrement the
        // count
    ...
    // Checks to see if the program was term with numbers entered or not
    if (cnt >= 1) {
      ave = sum / cnt;
    } else {
      ave = 0;
