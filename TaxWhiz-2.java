...
//--------------------------------------------------------------------------------
     ...
     * declares the cost of two items and passes it all to a receipt printing function. After this,
     * the tax rates are changed and everything is passed again to reprint a new receipt.
     */
